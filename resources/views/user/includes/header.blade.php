        ...
        <div class="container">
            <div class="header__top ul_li_between">
                <div class="header__top-cta">
                    <img src="{{ asset('user/assets/img/icon/n_pad.svg') }}" alt=""><span>Help Desk :</span> +91 590 088 55
                </div>
                <ul class="header__top-info ul_li">
                    <li><img src="{{ asset('user/assets/img/icon/time.svg') }}" alt="">Monday - Friday 09:00 am - 05:00 Pm</li>
                    <li><img src="{{ asset('user/assets/img/icon/location.svg') }}" alt="">456 Elm Avenue Springfield, IL 62701</li>
                </ul>
            </div>
        </div>
    </div>
