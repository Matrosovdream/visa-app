...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        ...
        <a href="{{ route('admin.home') }}">
            <img alt="Logo" src="{{ asset('assets/admin/media/app/default-logo.svg') }}" class="h-25px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ asset('assets/admin/media/app/default-logo.svg') }}" class="h-20px app-sidebar-logo-minimize" />
        </a>
