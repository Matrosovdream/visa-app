...
<div class="card card-flush">
        ...
        <div class="card-title">
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" data-kt-ecommerce-product-filter="search"
                    class="form-control form-control-solid w-250px ps-12" placeholder="Search Directions">
            </div>
        </div>
    </div>
    ...
    <div class="card-body pt-0">
                ...
                <tbody class="fw-semibold text-gray-600">
                    ...
                    @foreach($directions as $direction)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.directions.show', $direction->countryFrom->id) }}"
                                    class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                    data-kt-ecommerce-product-filter="product_name">
                                    {{ $direction->countryFrom->name }}
                                </a>
                                ->
                                <a href="{{ route('admin.directions.show', $direction->countryTo->id) }}"
                                    class="text-gray-800 text-hover-primary fs-5 fw-bold"
                                    data-kt-ecommerce-product-filter="product_name">
                            ...
                            <td class="text-right">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                    ...
                                    <div class="menu-item px-3">
                                        <a href="{{ route('admin.directions.show', $direction->id) }}"
        ...
        <div id="" class="row">
            {{ $directions->links('admin.includes.pagination.default') }}
        </div>
